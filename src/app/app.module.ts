...
import { CustomComponent } from './componente/dados-diarios/clima/clima/custom.component';
...
export const appRouters: Routes = [
  ...
  {
    path: 'gotejadorList',
    component: GotejadorComponent,
    canActivate: [GuardiaoGuard],
  },
  {
    path: 'gotejadorAdd',
    component: GotejadorAddComponent,
    canActivate: [GuardiaoGuard],
  },
  {
  ...
  {
    path: 'outorgaList',
    component: OutorgaComponent,
    canActivate: [GuardiaoGuard],
  },
  {
    path: 'outorgaAdd',
    component: OutorgaAddComponent,
    canActivate: [GuardiaoGuard],
  },
  {
    path: 'outorgaAdd/:id',
  ...
  {
    path: 'irrigacaoAdd',
    component: IrrigacaoAddComponent,
    canActivate: [GuardiaoGuard],
  },
  {
  ...
  {
    path: 'precipitacaoList',
    component: PrecipitacaoComponent,
    canActivate: [GuardiaoGuard],
  },
  {
    path: 'precipitacaoAdd',
    component: PrecipitacaoAddComponent,
    canActivate: [GuardiaoGuard],
  },
  {
    path: 'precipitacaoAdd/:id',
    component: PrecipitacaoAddComponent,
    canActivate: [GuardiaoGuard],
  },
];
